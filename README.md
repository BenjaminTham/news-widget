...
*   Just click and drag the text to move the window anywhere you like.
*   The window has a 90% opacity so it blends nicely with your desktop without being distracting.
*   Fetches the latest headlines from Channel News Asia (CNA) & The Straits Times (ST)
*   Headlines publish dates and summaries are color-coded for clarity.
*   Uses minimal system resources.
*   Just press the Escape key to close the app.
